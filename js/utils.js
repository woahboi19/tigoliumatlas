...
globalThis.SortUtil = {
	...
	_ITEM_RARITY_ORDER: ["none","bakır", "demir", "gümüş", "altın", "platin", "mitril", "common", "uncommon", "rare", "very rare", "legendary", "artifact", "varies", "unknown (magic)", "unknown"],
...
class BookModeViewBase {
	...
	async pOpen () {
		...
		document.title = `${this._pageTitle} - Atlas`;
